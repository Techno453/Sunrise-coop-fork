 ...
 * receipt.
 * The caller supplies a fresh outcome. Refusal stages no presence; the enclosing BAP
 * request
 * publishes it only after committing its reply. Join-lock flags never report player
 * arrival.
 */
[[nodiscard]] bool
